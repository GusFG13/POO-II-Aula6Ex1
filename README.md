# POO-II-Aula6Ex1
Nota:
Arquivo dicionario.csv diponível do repositório é apenas um exemplo de arquivo gerado usando o programa.Para ser usado deve ser colocado na pasta "c:\temp".
Se não existir a pasta ou arquivo previamente no local, o programa irá criar na primeira vez que for usado.
